...
export default function Page({ contents, topics, totalCount, thisPage, tweets, currentTopic }: any) {
    ...
    const date = new Date();
    let seo_data = {};
    (seo_data as any).publishedAt = date.toISOString();
    (seo_data as any).updatedAt = date.toISOString();
    (seo_data as any).seo_title = settings.general[0].name;
    (seo_data as any).topics = topics;
    return (<Layout title={title} seo_data={seo_data} seo_url={settings.general[0].url}>
        ...
        <header className="py-10">
          <div className="max-w-screen-xl m-auto px-10">
            <div className="relative text-center">
              ...
              {!currentTopic ? (<div className="flex items-center justify-center h-40">
