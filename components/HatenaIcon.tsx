...
export const HatenaIcon = ({ hatena_href, hatena_title }: Props) => {
  const handleClick = () => {
    gtag.event({
      action: 'Click',
      category: 'Share',
  ...
  return (
    <a
      ...
      data-tooltip-content="このページをはてなブックマークに登録する"
      onClick={handleClick}
      rel="noreferrer">
      <svg
        className="hatena-svg w-7 h-7 fill-current text-gray-500 hover:text-[#00A4DE] transition-colors cursor-pointer"
  ...
  V578.78h-87.887V312.461z M572.598,653.986c-8.818,16.071-22.229,29.182-38.492,37.614c-13.55,7.208-30.245,12.486-50.284,15.641
  c-20.041,3.047-52.73,4.571-98.079,4.571H272.891V312.461h109.504c45.004,0,76.46,1.223,94.398,4.206
  c17.928,3.004,33.215,8.11,46.046,15.127c14.076,7.53,25.769,18.86,33.75,32.678c7.897,14.634,11.888,31.027,11.587,47.656
